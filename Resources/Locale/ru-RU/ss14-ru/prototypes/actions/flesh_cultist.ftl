...
ent-FleshCultistSpiderlegs = Форма паука.
    .desc = Превращает часть вашего тела в форму паука, обеспечивая умеренную защиту и существенное увеличение скорости.
...
flesh-heart-cant-absorb-targer = Сердце отказывается от вашего предложения.
flesh-heart-activate-warning = Внимание! На станции обнаружена аномальная биологическая сигнатура. Всем сотрудникам службы безопасности дано указание немедленно ликвидировать цель.