...
blob-role-greeting =
    ...
    Используйте горячие клавиши Alt+ЛКМ, чтобы улучшать обычные плитки до сильных, а сильные до отражающих.
...
blob-objective-condition-success = { $condition } | [color={ $markupColor }]Успех![/color]
blob-objective-condition-fail = { $condition } | [color={ $markupColor }]Провал![/color] ({ $progress }%)