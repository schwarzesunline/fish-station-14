...
using Content.Server.Mosley.GameTicking.Rules.Components;
...
namespace Content.Server.Mosley.GameTicking.Rules;
                ...
                switch (blobRuleComp.Stage)
                {
                    ...
                    case BlobStage.Default:
                        ...
                        EntitySystem.Get<AlertLevelSystem>()
                            .SetLevel(stationUid!.Value, "red", true, true, true, false);
            ...
            foreach (var (mindId, mind) in blob.Blobs)
            {
                ...
                foreach (var objectiveGroup in objectives.GroupBy(o => Comp<ObjectiveComponent>(o).Issuer))
                {
                    foreach (var objective in objectiveGroup)
                    {
                        ...
                        {
                            result += "\n- " + Loc.GetString(
                                "blob-objective-condition-success",
